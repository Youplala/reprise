...
Objet : Paris GO, application mobile d'accompagnement de l'Observatoire — demande de confirmation écrite
...
Paris GO est en cours d'examen par Apple pour publication sur l'App Store. Apple me demande de
...
1. Les données publiques de l'Observatoire (stations, reprises publiées, prénoms et noms des
   ...
   Ville de Paris : Paris GO ne revendique aucun droit propre et ne fait que montrer, avec un lien
...
3. Le formulaire officiel https://observatoire-photo.paris/elements/add, affiché dans une vue web
   intégrée. Paris GO préremplit uniquement des champs publics vides (date, lieu, coordonnées, modèle
...
Paris GO ne possède aucun serveur : elle ne reçoit ni les identités ni les photos des utilisateurs,
...
- vous autorisez explicitement Paris GO à afficher les données publiques de l'Observatoire (stations,
