...
export function DeckCanvas({
  ...
  const usesReprisePanorama = connectedCanvas && theme.id === "reprise-archive";
  ...
  return (
    ...
    >
      {usesReprisePanorama && <ReprisePanorama cW={cW} cH={cH} totalW={totalW} />}
...
function ReprisePanorama({
  ...
  const seine = [
    `M ${-0.2 * cW} ${0.80 * cH}`,
    `C ${0.55 * cW} ${0.63 * cH}, ${1.12 * cW} ${0.91 * cH}, ${1.85 * cW} ${0.73 * cH}`,
    `S ${3.10 * cW} ${0.54 * cH}, ${3.88 * cW} ${0.72 * cH}`,
    `S ${5.18 * cW} ${0.88 * cH}, ${5.9 * cW} ${0.64 * cH}`,
  ].join(" ");
  const route = [
    `M ${-0.1 * cW} ${0.34 * cH}`,
    `C ${0.8 * cW} ${0.24 * cH}, ${1.25 * cW} ${0.48 * cH}, ${2.05 * cW} ${0.39 * cH}`,
    `S ${3.35 * cW} ${0.20 * cH}, ${4.18 * cW} ${0.36 * cH}`,
    `S ${5.25 * cW} ${0.53 * cH}, ${5.9 * cW} ${0.31 * cH}`,
  ].join(" ");
  const gridStep = cW * 0.11;
  ...
  return (
    <div
      ...
      style={{
        ...
        pointerEvents: "none",
        background:
          "linear-gradient(100deg, #F7F1E8 0%, #EAF1F2 23%, #F5E7DD 47%, #E5EEF0 70%, #F2E5DA 100%)",
      }}
    >
      <div
        style={{
          ...
          width: "36%",
          height: "98%",
          borderRadius: "42% 58% 62% 38% / 54% 44% 56% 46%",
          background: "linear-gradient(145deg, rgba(200,94,60,0.28), rgba(244,194,158,0.08))",
          transform: "rotate(-8deg)",
          filter: `blur(${cW * 0.025}px)`,
        }}
      />
      <div
        style={{
          ...
          width: "40%",
          height: "64%",
          borderRadius: "58% 42% 36% 64% / 42% 55% 45% 58%",
          background: "linear-gradient(120deg, rgba(15,35,58,0.14), rgba(91,135,153,0.04))",
          transform: "rotate(7deg)",
          filter: `blur(${cW * 0.03}px)`,
        }}
      />
      <div
        style={{
          ...
          width: "42%",
          height: "82%",
          borderRadius: "37% 63% 56% 44% / 58% 36% 64% 42%",
          background: "linear-gradient(155deg, rgba(227,153,120,0.22), rgba(255,239,218,0.05))",
          transform: "rotate(10deg)",
          filter: `blur(${cW * 0.028}px)`,
        }}
      />
      <div
        style={{
          ...
          inset: 0,
          opacity: 0.11,
          backgroundImage: `repeating-linear-gradient(0deg, transparent 0 ${gridStep - 2}px, #17364A ${gridStep - 2}px ${gridStep}px), repeating-linear-gradient(90deg, transparent 0 ${gridStep - 2}px, #17364A ${gridStep - 2}px ${gridStep}px)`,
        }}
      />
      <svg
        width={totalW}
      ...
      >
        ...
        <path
          d={seine}
          fill="none"
          stroke="rgba(248,251,249,0.72)"
          strokeWidth={cW * 0.026}
          strokeLinecap="round"
        />
        <path
          d={route}
          fill="none"
          stroke="rgba(247,242,232,0.88)"
          strokeWidth={cW * 0.022}
          strokeLinecap="round"
        />
        <path
          d={route}
          fill="none"
          stroke="#C85E3C"
          strokeWidth={cW * 0.0055}
          strokeLinecap="round"
          opacity={0.86}
        />
        {[0.72, 1.72, 2.76, 3.78, 4.78].map((screen, index) => (
          <circle
            key={screen}
            cx={screen * cW}
            cy={(0.31 + (index % 2) * 0.08) * cH}
            r={cW * 0.012}
            fill="#F7F1E8"
            stroke="#C85E3C"
            strokeWidth={cW * 0.005}
          />
        ))}
      </svg>
    </div>
