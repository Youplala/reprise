export const OFFICIAL_CONTRIBUTION_GUIDE = [
  {
    ...
    body: 'Reprise prépare les fichiers pendant que vous découvrez le formulaire officiel.',
    points: [
  ...
  },
  {
    ...
    body: 'Reprise remplit uniquement ce qui est certain et utile au dépôt.',
    points: [
  ...
  },
  {
    ...
    body: 'Le formulaire appartient à l’Observatoire. Reprise ne valide rien à votre place.',
    points: [
